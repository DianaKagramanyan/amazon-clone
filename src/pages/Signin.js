    ...
    <div className="w-full">
        ...
        <form className="w-[350px] mx-auto flex flex-col items-center">
          ...
          <div className="w-full border border-zinc-200 p-6">
            ...
            <div className="flex flex-col gap-3">
              ...
              <button onClick={(e) => e.preventDefault()} className="w-full py-1.5 text-sm font-normal rounded-sm
            ...
            <p className="text-xs text-black leading-4 mt-4">By continuing, you agree
              to Amazon's <span className="text-blue-600">Conditions of Use {" "}</span> and
      ...
      flex-col gap-4 justify-center items-center py-10">
        <div className="flex items-center gap-6">
          <p className="text-xs text-blue-600 hover:text-orange-600 hover:text-orange-600 hover:underline
